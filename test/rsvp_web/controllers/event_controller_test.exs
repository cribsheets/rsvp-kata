defmodule RsvpWeb.EventControllerTest do
  use RsvpWeb.ConnCase

  alias Rsvp.Events

  @create_attrs %{date: ~N[2010-04-17 14:00:00], title: "some title"}
  @update_attrs %{date: ~N[2011-05-18 15:01:01], title: "some updated title"}
